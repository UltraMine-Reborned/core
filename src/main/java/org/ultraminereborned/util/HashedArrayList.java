...
public class HashedArrayList<TileEntity> extends ArrayList<TileEntity> {
    private final MutableSet<TileEntity> hashed = MultiReaderUnifiedSet.newSet();
    ...
    public ListIterator<TileEntity> listIterator() {
        return new HashedArrayListIterator<>(super.listIterator(), this.hashed);
    }

    @Override
    public ListIterator<TileEntity> listIterator(int arg0) {
    ...
    static class HashedArrayIterator<TileEntity> implements Iterator<TileEntity> {
        Iterator<TileEntity> aritr;
        Set<TileEntity> teset;
        private TileEntity last = null;

        public HashedArrayIterator(Iterator<TileEntity> aritr, Set<TileEntity> teset) {
            this.aritr = aritr;
            this.teset = teset;
        }
    ...
    static class HashedArrayListIterator<TileEntity> implements ListIterator<TileEntity> {
        ListIterator<TileEntity> aritr;
        Set<TileEntity> teset;
        private TileEntity lastRet = null;

        public HashedArrayListIterator(ListIterator<TileEntity> aritr, Set<TileEntity> teset) {
            this.aritr = aritr;
        }
